\subsection{World Wide Collaboration}
...
over 2.1 million articles \mynote{update this?} and is
...
errors \mynote{similar, or better?} in both works~\cite{Giles2005}.
...
which is vandalized to be in March \mynote{look up the exact case
of vandalism} and noted in a paper on vandalism with the wrong
date \mynote{look up paper; reviewed Lincoln and Microsoft;
