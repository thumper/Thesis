...
\mynote{Is it important to include the complexity and memory usage
characteristics of our greedy algorithm?}
\mynote{Luca also suggested that it might be useful to do benchmarking
of the original Ocaml code (\texttt{Editdiff.core}) for optimized
and unoptimized versions, to explore the extent of how useful the
