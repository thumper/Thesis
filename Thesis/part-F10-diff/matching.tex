...
defined above is in the quality function.\footnote{Multiple
matching of source blocks cannot be handled by the quality
...
and increasing as the blocks move away from each other.
...
\end{tabular}
\end{center}
\caption{Comparing the performance of \textbf{WikiTrust::BasicTextTracking}
    with \textbf{WikiTrust::FasterTextTracking}.}
