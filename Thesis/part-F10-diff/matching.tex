...
The first optimization is in reducing the possible
...
Another optimization which can dramatically reduce the
number of potential matches is to assume that matching text
at the beginning and end of an article will always be the best match.
This assumption fits well with our desire that the resulting
