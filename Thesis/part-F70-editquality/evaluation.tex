...
together (shown in the tables as \mq1234 and \mq6789).
...
and \ed3 (Table~\ref{tab:editbylonged3}), the ranking between \diff1
and \diff2 is exchanged.
Even more telling, \diff1 gives the worst performance in the entire
experiment when combined with \ed2 (Table~\ref{tab:editbylonged2}),
