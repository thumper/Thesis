...
In using edit distance as a component of the edit longevity
formulation, we are trying to estimate the amount of \intro{effort}
that an author puts into making a revision to an article.
