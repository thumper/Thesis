...
it a good metric for the quality of a revision, except for judging the very worst
edits.
...
and any metric that only looks at how text is added will not capture it.
...
Our motivation for the edit quality metric is that the future
...
points to a host of potential quality metrics, such as
