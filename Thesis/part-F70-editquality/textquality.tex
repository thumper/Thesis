...
\mynote{TODO: Experiment: collect data for several different revisions.
Compute the decay for each one, and then compute the error from
the decay.  What are the statistics for this decay?  Tried running
on Santa Cruz Beach Boardwalk, but results were either revert or
keep all.  Rarely was there much change...}
