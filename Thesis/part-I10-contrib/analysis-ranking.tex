...
\begin{figure}[t]
    \begin{center}
    \includegraphics[width=0.45\textwidth]{part-I10-contrib/graphs/prct-editlong-textlong}
    \end{center}
...
\begin{figure}[t]
    \begin{center}
    \includegraphics[width=0.45\textwidth]{part-I10-contrib/graphs/prct-editlong-textwithpunish}
    \end{center}
...
\begin{figure}[t]
    \begin{center}
    \includegraphics[width=0.45\textwidth]{part-I10-contrib/graphs/prct-numedits-reputation}
    \end{center}
...
\begin{figure}[tbph]
    \begin{center}
    \includegraphics[width=0.45\textwidth]{part-I10-contrib/graphs/prct-editlong-reputation}
    \end{center}
...
\begin{figure}[tbph]
    \begin{center}
    \includegraphics[width=0.45\textwidth]{part-I10-contrib/graphs/prct-editlong-numedits}
    \end{center}
    \caption[$\editlong$ vs $\numedits$]{
    	$\editlong$ vs $\numedits$
    }
