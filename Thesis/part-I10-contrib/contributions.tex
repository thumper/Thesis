...
or simply the \intro{edit count}.
...
the version \version{i} being evaluated and version \version{i-1}
...
text quality measure \quality{tdecay}{10}{\version{i}}, which describes
...
average edit quality measure \quality{elong}{10}{\version{i}}.
...
We consider the ten revisions that follow any revision \version{i} of an
article, and accumulate the amount of text contribution that was made
in \version{i} that remained in each of those ten subsequent revisions
of the article.
