...
History is replete with examples of partnerships where it's
not clear how to value each person's contribution:
\begin{itemize}
\item Steve Jobs and Steve Wozniak.
\item The Marx Brothers, Groucho and those other two.
\item Paul Erd\"os and a host of others.
\item King Arthur and Merlin
\end{itemize}
...
encyclopedia built on wiki technology~\cite{Leuf2001}. 
...
content of the Wikipedia \cite{Wales2005,Swartz2006,Kittur2007}. 
...
Kittur2007,Suh2008,OrtegaBarahona2007,Stein2007},
...
\cite{Wagner1974,Tichy1984,Cormode2007}. 
...
noting citations~\cite{Page1999,Giles2004,WikiMTWtrust06}.
...
In~\cite{Korfiatis2006}, the authors examine the sequence of edits
...
In~\cite{Shirky2008}, the total amount of work that went
