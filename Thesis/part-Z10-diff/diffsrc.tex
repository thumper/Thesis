...
sub compute_heap {
  my ($this, $chunk, $w1, $skipmatch, $eachk, $maxk) = @_;
  confess "Need skipmatch" if !defined $skipmatch;
  confess "Need eachk" if !defined $eachk;
  confess "Need maxk" if !defined $maxk;
  my $w2 = $this->{dst};
  my $l1 = scalar(@$w1);
  my $l2 = scalar(@$w2);
