...
The actual contribution as described is \dist{}{k-1,j},
...
projection of \dist{}{k,j}: we want to punish the author by the amount
...
In other words, I think we should use the projection of \dist{}{k-1,k}
onto \dist{}{k-1,j}, but make sure that it's capped to \dist{}{k-1,j}.
\mynote{Try running this experiment.}
...
Also tried to run diff9, and gave it 4GB of memory, but it never
