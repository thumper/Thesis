...
\framebox{\includegraphics[width=0.42\textwidth]{paper-rep/textcontr-2}}
}
\hspace{1ex}
\subfigure[Calculating the \textit{text longevity} of a contribution.]{
\label{fig-textcontr-b}
\framebox{\includegraphics[width=0.48\textwidth]{paper-rep/text-longevity}}
}
...
\framebox{\includegraphics[width=0.35\textwidth]{paper-rep/editcontr-good}}
}
\hspace{1ex}
\subfigure[Graphical representation of a bad edit contribution.]{
\label{fig-editcontr-b}
\framebox{\includegraphics[width=0.40\textwidth]{paper-rep/editcontr-bad}}
}
...
\begin{figure}
\centering
\framebox{\includegraphics[width=0.35\textwidth]{paper-rep/edit-longevity}}
