...
ok($s->[2] eq WikiTrust::Tuple->new('Del',3,5));
ok($s->[3] eq WikiTrust::Tuple->new('Del',10,1));
ok($s->[4] eq WikiTrust::Tuple->new('Ins',3,2));
ok($s->[5] eq WikiTrust::Tuple->new('Ins',7,1));
